...
public class EditUserVerkoperForm extends ActionSupport implements SessionAware {

	private static final long serialVersionUID = 8508865338475898572L;
	...
	private Verkoper gezocht;
	
	public String execute() {
		alleVerkopers = ivs.alleVerkopers();
		for (Verkoper v : alleVerkopers) {
		...
		bedrijfsnaam = gezocht.getBedrijfsnaam();
		kvknummer = gezocht.getKvkNummer();
		rekeningnummer = gezocht.getRekeningnummer();
	...
	public void setGezocht(Verkoper gezocht) {
